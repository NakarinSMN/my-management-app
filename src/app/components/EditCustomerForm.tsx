...
export default function EditCustomerForm({ customerData, onSuccess, onCancel }: EditCustomerFormProps) {
  ...
  return (
    <>
      <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-[800px] w-full mx-auto border border-gray-200 dark:border-gray-700 p-6 md:p-8">image.png
